...
func (hs *HTTPServer) registerRoutes() {
	...
	// sphinx wrappers for some apis
	fnLoginPost := hs.LoginPost
	fnLoginPostSM := hs.LoginPostSM
	fnAdminCreateUser := AdminCreateUser
	fnAdminDeleteUser := AdminDeleteUser
	fnAdminEnableUser := AdminEnableUser
	fnAdminDisableUser := hs.AdminDisableUser
	if hs.Cfg.SphinxSm.EnableIntegration {
		fnLoginPost = hs.SphinxWrapperLoginPost
		fnLoginPostSM = hs.SphinxWrapperLoginPostSM
		fnAdminCreateUser = hs.SphinxWrapperAdminCreateUser
		fnAdminDeleteUser = hs.SphinxWrapperAdminDeleteUser
		fnAdminEnableUser = hs.SphinxWrapperAdminEnableUser
		fnAdminDisableUser = hs.SphinxWrapperAdminDisableUser
	}
	...
	// BEFORE SPHINX TICKET AUX: r.Post("/login", quota("session"), bind(dtos.LoginCommand{}), Wrap(fnLoginPost))
	r.Post("/login", quota("session"), bind(dtos.LoginCommand{}), Wrap(fnLoginPost))
	r.Post("/loginSM", quota("session"), bind(dtos.LoginModel{}), Wrap(fnLoginPostSM))
	...
	r.Group("/api/admin", func(adminRoute routing.RouteRegister) {
		...
		adminRoute.Post("/users", bind(dtos.AdminCreateUserForm{}), Wrap(fnAdminCreateUser))
		...
		adminRoute.Delete("/users/:id", Wrap(fnAdminDeleteUser))
		adminRoute.Post("/users/:id/disable", Wrap(fnAdminDisableUser))
		adminRoute.Post("/users/:id/enable", Wrap(fnAdminEnableUser))
