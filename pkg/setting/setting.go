...
func (cfg *Cfg) Load(args *CommandLineArgs) error {
	...
	cfg.SphinxSm = &SphinxSmSettings{}
	readSphinxSmSettings(iniFile, cfg)
...
// SphinxSmConfig contains the config settings available for SPHINX Service Manager integration
type SphinxSmSettings struct {
...
func readSphinxSmSettings(iniFile *ini.File, cfg *Cfg) {
	sphinxSm := iniFile.Section("sphinx_sm")

	cfg.SphinxSm.EnableIntegration = sphinxSm.Key("enable_integration").MustBool(false)
	cfg.SphinxSm.BaseURL = sphinxSm.Key("base_url").String()
	cfg.SphinxSm.SsoAdminUsername = sphinxSm.Key("sso_admin_username").String()
	cfg.SphinxSm.SsoAdminPassword = sphinxSm.Key("sso_admin_password").String()
	cfg.SphinxSm.TokenExpires = sphinxSm.Key("token_expire").String()
}
